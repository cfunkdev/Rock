...
namespace Rock.Blocks.Core
{
    ...
    public class TagList : RockEntityListBlockType<Tag>
    {
        ...
        private static class PreferenceKey
        {
            ...
            public const string FilterEntityType = "filter-entity-name";
        ...
        protected string FilterEntityType => GetBlockPersonPreferences()
            .GetValue( PreferenceKey.FilterEntityType ).FromJsonOrNull<ListItemBag>()?.Value;
        ...
        protected override IQueryable<Tag> GetListQueryable( RockContext rockContext )
        {
            ...
            var entityTypeGuid = FilterEntityType.AsGuidOrNull();
