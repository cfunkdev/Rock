...
export const EditComponent = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        watch(() => props.configurationValues, () => {
            ...
            templateBlockValueGuid.value = templateKey.value ? templateBlock.value : null;
        }, {
            immediate: true
        });
...
export const ConfigurationComponent = defineComponent({
    ...
    template: `
    <DefinedValuePicker v-model="internalValue" label="Template Block" :definedTypeGuid="definedTypeGuid" help="An optional setting to select template block from." />
`
});