...
namespace Rock.Reporting
{
    ...
    /// </summary>
    [RockInternal( "1.17" )]
    public class DataViewQueryBuilder
    {
        #region Instancing

        private static Lazy<DataViewQueryBuilder> _dataManager = new Lazy<DataViewQueryBuilder>();
        ...
        /// <returns></returns>
        public IQueryable<T> GetDataViewFilterQuery<T>( int dataViewFilterId, GetEntityQueryArgs args )
        ...
        /// <param name="args"></param>
        /// <returns></returns>
        public IQueryable<IEntity> GetDataViewFilterQuery( IDataViewFilterDefinition dataViewFilter, Type queryEntityType, GetEntityQueryArgs args = null )
        {
            args = args ?? new GetEntityQueryArgs();
        ...
        /// </exception>
        public IQueryable<IEntity> GetDataViewQuery( IDataViewDefinition dataView, GetEntityQueryArgs dataViewGetQueryArgs = null )
        {
            dataViewGetQueryArgs = dataViewGetQueryArgs ?? new GetEntityQueryArgs();
        ...
        /// <returns></returns>
        public bool IsUserAuthorizedToViewResults( IDataViewDefinition dataView, Person CurrentPerson )
        {
            if ( dataView == null )
            {
                return false;
        ...
        private Expression GetDataViewExpression( IDataViewDefinition dataView, IService serviceInstance, ParameterExpression paramExpression, DataViewFilterOverrides dataViewFilterOverrides )
        {
            ...
            var filterExpression = dataView.DataViewFilter != null ? GetDataFilterExpression( dataViewFilter, resultEntityType, serviceInstance, paramExpression, dataViewFilterOverrides ) : null;
        ...
        /// </summary>
        public sealed class GetEntityQueryArgs
        {
            /// <summary>
